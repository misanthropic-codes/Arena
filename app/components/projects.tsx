...
const projects = [
  ...
  { imageSrc: '/images/qubaa-school.png', text: 'Qubaa school/ mombasa' },
  { imageSrc: '/images/jamhuri-arena.png', text: 'Jmahuri Arena' },
...
const ProjectsSection: React.FC = () => {
  return (
    <section className="flex flex-col items-center justify-center bg-[#FFFFF6] py-16 px-8">
      <h2 className="text-3xl font-bold text-green-900 mb-12 text-center">Projects</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-32 max-w-6xl mx-auto">
